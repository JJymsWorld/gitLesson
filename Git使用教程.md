...
`git config --global user.eamil "email@examle.com"`
...
`git log` 如果嫌输出信息太多，看得眼花缭乱的，可以试试加上`--pretty=oneline`参数
...
`git remote add origin git@github.com:michaelliao/learngit.git`(替换其中的内容为自己的)
